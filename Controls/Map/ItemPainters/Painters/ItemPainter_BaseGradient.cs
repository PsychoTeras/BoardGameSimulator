...
#region Paint functions
        ...
        private void CalculateWorkplaceRectangle(MapItem item)
        {
        ...
        private void DrawHeader(MapItem item)
        {
        ...
        private void DrawWorkplace(MapItem item)
        {
        ...
        private void DrawWorkplaceFromBuffer(MapItem item)
        {
            //Draw workplace buffer
            item.Buffer.DrawImageUnscaledAndClipped(item.WorkplaceBuffer.BufferBitmap,
                item.WorkplaceRectangle);
        ...
        private void DrawGroup(MapItem item, ItemGroup group, 
        ...
        private void DrawGroupElement(MapItem item, ItemGroupElement element,
        ...
        public override void UpdateLinkPoints(MapItem item, ItemLinkPoint[] linkPoints)
        {
        ...
        private void DrawLinkPoint(MapItem item, ItemLinkPoint[] linkPoints)
        {
