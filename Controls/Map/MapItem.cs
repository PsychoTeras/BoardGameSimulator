...
using BoardGameSimulator.Controls.Map.ItemPainters;
using BoardGameSimulator.Controls.Map.LinkingArrowControl;

namespace BoardGameSimulator.Controls.Map
{
    public partial class MapItem : Control, IMessageFilter
    {
...
#region Internal members
        ...
        internal Map.OnItemMouseEvent ItemMouseDown;
        internal Map.OnItemMouseEvent ItemMouseUp;
        internal Map.OnItemMouseClick ItemMouseClick;
        internal Map.OnItemControlMouseEvent ItemControlMouseDown;
        internal Map.OnItemControlMouseEvent ItemControlMouseUp;
        internal Map.OnItemControlMouseClick ItemControlMouseClick;
        internal Map.OnItemDragEnter ItemDragEnter;
        internal Map.OnItemDragDrop ItemDragDrop;
        internal Map.OnItemLocation ItemMoved;
        internal Map.OnItemLocation ItemResized;
...
#region Properties
        ...
        public new Map Parent
        {
            get { return (Map) base.Parent; }
...
#region Class functions
        ...
        public MapItem(Map parent, string skinName)
        {
